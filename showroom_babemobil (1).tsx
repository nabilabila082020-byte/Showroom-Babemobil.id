...
const pageData = {
  ...
  testimonials: [
    { name: "Budi Santoso", car: "Toyota Innova 2020", rating: 5, text: "Proses kredit sangat cepat dibantu sampai deal. Mobil kondisinya istimewa banget, luar dalam mulus. Terima kasih babemobil.id!" },
    { name: "Siti Rahma", car: "Honda Brio 2021", rating: 5, text: "Beli mobil bekas rasa baru. Stafnya ramah dan transparan soal kondisi mobil. Dapat bonus poles bodi juga." },
    { name: "Ahmad Wijaya", car: "Mitsubishi Pajero 2019", rating: 4, text: "Pilihan unitnya banyak dan rapi. Harga juga bersaing. Rekomen buat yang cari SUV gagah kondisi prima." }
  ],
  faqs: [
...
const carCatalog = [
  // MPV
  { id: 1, brand: "Toyota", name: "Avanza 1.3 G", type: "MPV", year: "2019", condition: "Seken", transmission: "Manual", price: "Rp 165 Jt", image: "https://images.unsplash.com/photo-1549317661-bd32c8ce0db2?auto=format&fit=crop&q=80&w=500&h=300" },
  { id: 2, brand: "Toyota", name: "Innova Zenix", type: "MPV", year: "2023", condition: "Baru", transmission: "CVT", price: "Rp 425 Jt", image: "https://images.unsplash.com/photo-1609521263047-f8f205293f24?auto=format&fit=crop&q=80&w=500&h=300" },
  { id: 8, brand: "Daihatsu", name: "Xenia 1.3 R", type: "MPV", year: "2020", condition: "Seken", transmission: "Automatic", price: "Rp 175 Jt", image: "https://images.unsplash.com/photo-1549317661-bd32c8ce0db2?auto=format&fit=crop&q=80&w=500&h=300&hue=180" },
  { id: 9, brand: "Suzuki", name: "Ertiga GL", type: "MPV", year: "2018", condition: "Seken", transmission: "Manual", price: "Rp 150 Jt", image: "https://images.unsplash.com/photo-1609521263047-f8f205293f24?auto=format&fit=crop&q=80&w=500&h=300&sat=50" },
  { id: 15, brand: "Toyota", name: "Voxy 2.0 A/T", type: "MPV", year: "2021", condition: "Seken", transmission: "Auto", price: "Rp 450 Jt", image: "https://images.unsplash.com/photo-1549317661-bd32c8ce0db2?auto=format&fit=crop&q=80&w=500&h=300&hue=300" },
  
  // SUV
  { id: 4, brand: "Toyota", name: "Fortuner GR", type: "SUV", year: "2022", condition: "Seken", transmission: "Auto", price: "Rp 550 Jt", image: "https://images.unsplash.com/photo-1626668893632-6f0282b0e6df?auto=format&fit=crop&q=80&w=500&h=300" },
  { id: 5, brand: "Honda", name: "BR-V Prestige", type: "SUV", year: "2020", condition: "Seken", transmission: "Auto", price: "Rp 235 Jt", image: "https://images.unsplash.com/photo-1513224502586-d1e602410265?auto=format&fit=crop&q=80&w=500&h=300" },
  { id: 7, brand: "Mitsubishi", name: "Pajero Dakar", type: "SUV", year: "2018", condition: "Seken", transmission: "Auto", price: "Rp 420 Jt", image: "https://images.unsplash.com/photo-1650821557088-348df80e6ef5?auto=format&fit=crop&q=80&w=500&h=300" },
  { id: 10, brand: "Hyundai", name: "Creta Prime", type: "SUV", year: "2023", condition: "Baru", transmission: "IVT", price: "Rp 408 Jt", image: "https://images.unsplash.com/photo-1626668893632-6f0282b0e6df?auto=format&fit=crop&q=80&w=500&h=300&hue=220" },
  { id: 16, brand: "Honda", name: "HR-V SE", type: "SUV", year: "2022", condition: "Seken", transmission: "CVT", price: "Rp 350 Jt", image: "https://images.unsplash.com/photo-1513224502586-d1e602410265?auto=format&fit=crop&q=80&w=500&h=300&hue=150" },
  { id: 17, brand: "Toyota", name: "Rush TRD", type: "SUV", year: "2020", condition: "Seken", transmission: "Auto", price: "Rp 220 Jt", image: "https://images.unsplash.com/photo-1626668893632-6f0282b0e6df?auto=format&fit=crop&q=80&w=500&h=300&sat=80" },

  // LCGC & City Car
  { id: 3, brand: "Honda", name: "Brio Satya E", type: "LCGC", year: "2021", condition: "Seken", transmission: "CVT", price: "Rp 145 Jt", image: "https://images.unsplash.com/photo-1603584173870-7f23fdae1b7a?auto=format&fit=crop&q=80&w=500&h=300" },
  { id: 11, brand: "Toyota", name: "Agya 1.2 G", type: "LCGC", year: "2022", condition: "Seken", transmission: "Manual", price: "Rp 135 Jt", image: "https://images.unsplash.com/photo-1603584173870-7f23fdae1b7a?auto=format&fit=crop&q=80&w=500&h=300&hue=50" },
  { id: 12, brand: "Daihatsu", name: "Ayla 1.0 M", type: "LCGC", year: "2019", condition: "Seken", transmission: "Manual", price: "Rp 95 Jt", image: "https://images.unsplash.com/photo-1603584173870-7f23fdae1b7a?auto=format&fit=crop&q=80&w=500&h=300&sat=0" },
  { id: 18, brand: "Daihatsu", name: "Sigra 1.2 R", type: "LCGC", year: "2022", condition: "Baru", transmission: "Manual", price: "Rp 155 Jt", image: "https://images.unsplash.com/photo-1603584173870-7f23fdae1b7a?auto=format&fit=crop&q=80&w=500&h=300&hue=280" },
  { id: 19, brand: "Toyota", name: "Calya 1.2 G", type: "LCGC", year: "2021", condition: "Seken", transmission: "Auto", price: "Rp 140 Jt", image: "https://images.unsplash.com/photo-1603584173870-7f23fdae1b7a?auto=format&fit=crop&q=80&w=500&h=300&hue=10" },

  // Pickup & Commercial
  { id: 6, brand: "Suzuki", name: "Carry Pickup", type: "Pickup", year: "2022", condition: "Baru", transmission: "Manual", price: "Rp 160 Jt", image: "https://images.unsplash.com/photo-1559416523-140ddc3d238c?auto=format&fit=crop&q=80&w=500&h=300" },
  { id: 13, brand: "Daihatsu", name: "GranMax PU", type: "Pickup", year: "2021", condition: "Seken", transmission: "Manual", price: "Rp 120 Jt", image: "https://images.unsplash.com/photo-1559416523-140ddc3d238c?auto=format&fit=crop&q=80&w=500&h=300&hue=120" },
  { id: 14, brand: "Mitsubishi", name: "L300 PU FB", type: "Pickup", year: "2023", condition: "Baru", transmission: "Manual", price: "Rp 230 Jt", image: "https://images.unsplash.com/photo-1559416523-140ddc3d238c?auto=format&fit=crop&q=80&w=500&h=300&sat=20" },
  { id: 20, brand: "Toyota", name: "Hilux Single Cabin", type: "Pickup", year: "2022", condition: "Seken", transmission: "Manual", price: "Rp 210 Jt", image: "https://images.unsplash.com/photo-1559416523-140ddc3d238c?auto=format&fit=crop&q=80&w=500&h=300&hue=50" },
];
...
export default function App() {
  ...
  const renderAdvantageIcon = (iconName) => {
    switch(iconName) {
